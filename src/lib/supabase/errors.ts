export const SCHEMA_SETUP_MESSAGE =
  "Drawing coach database not set up yet. Open Supabase Dashboard → SQL Editor, paste the contents of supabase/schema.sql from this repo, and click Run.";
...
export function isMissingTableError(error: unknown): boolean {
  ...
  return (
    ...
    Boolean(
      record.message?.includes("drawing_sessions") &&
